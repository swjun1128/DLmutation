...
def mutant_kill_rate(path,test_suite,mnist,isCNN=False):
    if isCNN==False:
        image_data=mnist.test.images
    else:
...
if __name__=='__main__':
    ...
    path_lst=glob.glob('./mutated/MODEL_A/*.hdf5')
    ...
    dataframe.to_csv('result_model_A.csv')